  ...
  return (
    <div className="stillThinking">
      <span className="stillThinkingText">
        Ещё думаете? Мы всё продумали! <BrainIcon className="brainIcon" />
        Все сложности мы берем на себя. <BoxIcon className="boxIcon" />
        Вам остается только принять товар и оплатить доставку <TrailerIcon /> .
      </span>
      <div
        ref={containerRef}
