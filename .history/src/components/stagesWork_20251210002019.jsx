        ...
        >
          <div className="num" ref={(el) => (numRefs.current.delivery = el)}>
            <span
              className="numDigit"
              style={{
                left: `${(1 - digitPositions.delivery) * 100}%`,
                transform: `translateX(${(digitPositions.delivery - 0.5) * -100}%)`,
              }}
            >
              03
            </span>
        ...
        >
          <div className="num" ref={(el) => (numRefs.current.receiving = el)}>
            <span
              className="numDigit"
              style={{
                left: `${(1 - digitPositions.receiving) * 100}%`,
                transform: `translateX(${(digitPositions.receiving - 0.5) * -100}%)`,
              }}
            >
              04
            </span>
