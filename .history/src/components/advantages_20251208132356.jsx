      ...
      <div className="advantagesContainer">
        <div
          ...
          className={`advantagesCard1 ${
            visibleCards["1"] ? "advantages-card-visible-first" : "advantages-card-hidden-first"
          }`}
        >
        ...
        <div
          ...
          className={`advantagesCard2 ${
            visibleCards["2"] ? "advantages-card-visible-second" : "advantages-card-hidden-second"
          }`}
        >
          <button className="advantagesBtn">ПОДРОБНЕЕ</button>
        ...
        <div
          ...
          className={`advantagesCard3 ${
            visibleCards["3"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
        ...
        <div
          ...
          className={`advantagesCard4 ${
            visibleCards["4"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
          <button className="advantagesBtn">ПОДРОБНЕЕ</button>
        ...
        <div
          ...
          className={`advantagesCard5 ${
            visibleCards["5"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
        ...
        <div
          ...
          className={`advantagesCard6 ${
            visibleCards["6"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
          <button className="advantagesBtn">ПОДРОБНЕЕ</button>
        ...
        <div
          ...
          className={`advantagesCard7 ${
            visibleCards["7"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
        ...
        <div
          ...
          className={`advantagesCard8 ${
            visibleCards["8"] ? "advantages-card-visible" : "advantages-card-hidden"
          }`}
        >
          <button className="advantagesBtn">ПОДРОБНЕЕ</button>
