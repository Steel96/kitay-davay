...
export default function Main() {
  ...
  const translateX = mousePosition.x * 20; // Максимальное смещение 20px
  const translateY = mousePosition.y * 20; // Максимальное смещение 20px
  ...
  return (
    <div className="main" ref={mainRef}>
      <div className="mainContent">
        ...
        <span className="mainText">{texts[currentTextIndex]}</span>
