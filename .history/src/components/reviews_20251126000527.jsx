    ...
    <div className="reviews">
      ...
      <div className="reviewContent">
        ...
        <span className="reviewContentText">
          ...
          главное, они всегда держат клиента в курсе всех этапов отправки груза.
          Когда твой перевозчик контролирует все процессы, это очень
        ...
        <div className="reviewCounter">
          ...
          <span className="reviewCounterNumRight">2</span>
        </div>
      </div>
    </div>
  );
